...
<html>
    <head>
        ...
        <body>
            <div class="top">
                <div class="top-title icon-home">学生学习心得分享平台</div>
                <div class="top-right">
                    <a href="/home/index/index" target="_blank">前台首页</a>
                </div>
            </div>
            ...
            <div class="login">
                <div class="login-wrap">
                    ...
                    <div class="login-box">
                        <form method="post" action="/home/admin/login">
                            <table>
                                ...
                                <tr><th></th><td><img src="/home/admin/yzm" id="captcha" alt="验证码" title="点击刷新验证码"></td></tr>
