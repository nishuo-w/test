...
<html lang="zh">
    ...
    <body>
        <?php echo ($msg); ?>
            ...
            <form method="post" action="/home/index/addblogdata/id/<?php echo ($data[0]['id']); ?>">
            <div id="layout" style="height: 2000px;background: #f6f6f6;">
                <header class="container">
                    <div class="col-md-5"><input type="text" name="title" required=""  class="title_input" value="<?php echo ($data[0]['title']); ?>"></div>
                    <div>
                       关键词：<input type="text" name="keywords" value="<?php echo ($data[0]['keywords']); ?>"/>&nbsp;&nbsp;
                       标 签：
                        <select name="name" >
                            <?php echo ($c); ?>
                        </select>
                    ...
                    <div class="right_box col-md-4">
                        <input type="submit" name="submit" value="保存修改" class="submit_btn">
                        <div class="imgpath"><img src="/public/img/index/1.jpg" alt=""/></div>
                    </div>
                </header>
                
                <div id="test-editormd" >
                    <textarea name="content" autofocus="autofocus"  required><?php echo ($data[0]['content']); ?></textarea>
                </div>
            </div>  
        </form>
